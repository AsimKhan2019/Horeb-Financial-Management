...
using Horeb.Pesistency.Specification;
...
namespace Samba.Persistance.Data
{
    public static class Dao
    {
        ...
        private static void AddToCache<T>(T item) where T : class,IBaseEntity
        {
            if (item == null) return;
        ...
        public static TResult Single<TSource, TResult>(int id, Expression<Func<TSource, TResult>> expression) where TSource : class,IBaseEntity
        {
        ...
        public static T SingleWithCache<T>(Expression<Func<T, bool>> predictate) where T : class, IBaseEntity
        {
        ...
        public static IDictionary<int, T> BuildDictionary<T>() where T : class,IBaseEntity
        {
        ...
        public static T Last<T>(Expression<Func<T, bool>> predictate, params Expression<Func<T, object>>[] includes) where T : class ,IBaseEntity
        {
            using (var workspace = WorkspaceFactory.CreateReadOnly())
            {
        ...
        public static IEnumerable<T> Last<T>(int recordCount) where T : class,IBaseEntity
        {
            using (var workspace = WorkspaceFactory.CreateReadOnly())
            {
