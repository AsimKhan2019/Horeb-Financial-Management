...
using Horeb.Infrastructure.Data.Helpers;

namespace Horeb.Infrastructure.Data.Settings
{
    ...
    public static class LocalSettings
    {
        ...
        public static string CommonSettingsFileName { get { return DataPath + "\\HorebSettings.txt"; } }
        public static string UserSettingsFileName { get { return UserPath + "\\HorebSettings.txt"; } }
        ...
        private static string DefaultAppVersion { get { return "1.0 BETA"; } }
        ...
        public static string AppName { get { return "Horeb"; } }

        private static IList<string> _supportedLanguages;
        public static IList<string> SupportedLanguages { get { return _supportedLanguages ?? (_supportedLanguages = new[] { "en", "es" }); } }
