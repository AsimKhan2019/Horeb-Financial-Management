 ...
 namespace Horeb.Infrastructure.Data
{
  public class SuperResource
  {
    ...
    private static SuperResource loader;
    private ResourceManager resources;

    public SuperResource()
    {
      this.resources = new ResourceManager("Horeb.Infrastructure.Data", this.GetType().Assembly);             
    }

    private static SuperResource GetLoader()
    {
      if (SuperResource.loader == null)
      {
        SuperResource sr = new SuperResource();
        Interlocked.CompareExchange<SuperResource>(ref SuperResource.loader, sr, (SuperResource)null);
      }
      return SuperResource.loader;
    }
    ...
    public static ResourceManager Resources
    {
      get
      {
        return SuperResource.GetLoader().resources;
      }
    }

    public static string GetString(string name, params object[] args)
    {
        SuperResource loader = SuperResource.GetLoader();
        if (loader == null)
        return (string) null;
        string format = loader.resources.GetString(name, SuperResource.Culture);
    ...
    {
      return SuperResource.GetLoader()?.resources.GetString(name, SuperResource.Culture);
    }

    public static string GetString(string name, out bool usedFallback)
    {
      usedFallback = false;
      return SuperResource.GetString(name);
    }

    public static object GetObject(string name)
    {
      return SuperResource.GetLoader()?.resources.GetObject(name, SuperResource.Culture);
    }
  }
}
